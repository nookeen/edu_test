...
"use strict";
  ...
  var MODULE_UTILITIES = (function() {
    ...
    function showAlertBox(text, alertClass) {
      ...
      settings.jAlertBox.prependTo('nav').slideDown(500);
    ...
    function _render(url) {
      ...
      var map = {
        ...
        '#single-question': function() {
          (isLoggedIn() === false) ? redirect('', true) : _renderSingleQuestionPage();
        }
      };
  ...
  var MODULE_DB = (function() {
    ...
    function _addUser(userData) {
      db.transaction("rw", db.users, function() {
        ...
        // Activate logout
        settings.jBody.find('.logout').addClass('visible');
